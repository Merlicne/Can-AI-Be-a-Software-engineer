...
public class DatabaseProxy implements Database {
    ...
    @Override
    public void create(String data) {
        System.out.println("Proxy: Checking access for create operation.");
        realDatabase.create(data);
    }

    @Override
    public String read(int id) {
        System.out.println("Proxy: Checking access for read operation.");
        return realDatabase.read(id);
    }

    @Override
    public void update(int id, String data) {
        System.out.println("Proxy: Checking access for update operation.");
        realDatabase.update(id, data);
    }

    @Override
    public void delete(int id) {
        System.out.println("Proxy: Checking access for delete operation.");
